...
export default class Vector {
   ...
   * @return {Vector} Returns the Vector.
   */
  public add(x: number, y: number, z = 0): Vector {
    this.x += x;
    this.y += y;
    this.z += z;
    return this;
   ...
   * @return {Vector} Returns the Vector.
   */
  public sub(x: number, y: number, z = 0): Vector {
    this.x -= x;
    this.y -= y;
    this.z -= z;
    return this;
   ...
   * @return {Vector} Returns the Vector.
   */
  public mul(x: number, y: number, z = 1): Vector {
    this.x *= x;
    this.y *= y;
    this.z *= z;
    return this;
   ...
   * @return {Vector} Returns the Vector.
   */
  public div(x: number, y: number, z = 1): Vector {
    this.x /= x;
    this.y /= y;
    this.z /= z;
    return this;
   ...
   * @param {Vector} vec - The vector to check against.
   ...
   * @param {Vector} vec - The distance to compare against.
   * @return {number} Returns the Distance.
   */
