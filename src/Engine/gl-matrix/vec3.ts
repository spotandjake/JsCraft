...
import type { ReadonlyVec3, vec3, ReadonlyMat3, ReadonlyQuat, ReadonlyMat4 } from './Types';
/**
...
export function create(): vec3 {
  const out = <vec3>glMatrix.ARRAY_TYPE(3);
...
export const forEach = (() => {
  ...
  return (
    ...
    offset: number,
    count: number,
    fn: (vec0: vec3, vec1: vec3, arg: any[]) => void,
    arg: any[]
  ) => {
    let i, l;
