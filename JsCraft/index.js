...
// Load modules
var modules = {};
modules.helpers = require( "./static/js/helpers.js" );
modules.blocks = require( "./static/js/blocks.js" );
modules.world = require( "./static/js/world.js" );
modules.network = require( "./static/js/network.js" );
